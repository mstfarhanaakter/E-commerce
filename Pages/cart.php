        ...
        <div class="row px-xl-5">
                            ...
                            <?php foreach ($_SESSION['cart'] as $id => $item): ?>
                                <tr>
                                    <td class="align-middle">
                                        <img src="../admin/<?= htmlspecialchars($item['images']); ?>"
                                            alt="<?= htmlspecialchars($item['name']); ?>" style="width:50px;">
                                        <?= htmlspecialchars($item['name']); ?>
                                    </td>
                                    <td class="align-middle">৳<?= number_format($item['price'], 2); ?></td>
                                    <td class="align-middle">
                                        <div class="input-group quantity mx-auto" style="width: 120px;">
                                            <a href="cart.php?update=<?= $id ?>&action=minus"
                                                class="btn btn-sm btn-primary">-</a>
                                            <input type="text"
                                                class="form-control form-control-sm bg-secondary border-0 text-center"
                                                value="<?= $item['quantity']; ?>" readonly>
                                            <a href="cart.php?update=<?= $id ?>&action=plus"
                                                class="btn btn-sm btn-primary">+</a>
                                        </div>
                                    </td>
                                    <td class="align-middle">৳<?= number_format($item['price'] * $item['quantity'], 2); ?></td>
                                    <td class="align-middle">
                                        <a href="cart.php?remove=<?= $id ?>" class="btn btn-sm btn-danger"><i
            ...
            <div class="col-lg-4">
                ...
                <div class="bg-light p-30 mb-5">
                    ...
                    <br>
                    <div class="p-0 ">
                        <input type="radio" class="mb-3" name="c">&nbsp; Cash on Delivery
                        <br>
                        <input type="radio" class="mb-3" name="c"> &nbsp; Online Payment
                    </div>
                    <div class="pt-2">
                        <div class="d-flex justify-content-between mt-2">
                            <h5>Total</h5>
                        ...
                        <button class="btn btn-block btn-primary font-weight-bold my-3 py-3"
                            onclick="alert('Your order has been placed'); ; window.location.href='../main.php';" type="button">
                            <a href="checkout.php" class="text-decoration-none text-black font-bold">Proceed To Checkout</a>
                        </button>
                    </div>
