            ...
            <table class="table table-striped table-bordered align-middle text-center">
              ...
              <tbody>
                ...
                <tr>
                  ...
                  <td>
                    <a href="edit_coupon.php?id=<?php echo $row['id']; ?>" class="btn btn-sm btn-success" data-bs-toggle="tooltip" title="Edit Coupon">
                      <i class="bi bi-pencil"></i> Edit
                    </a>
                    <a href="delete_coupon.php?id=<?php echo $row['id']; ?>" class="btn btn-sm btn-danger" data-bs-toggle="tooltip" title="Delete Coupon" onclick="return confirm('Are you sure you want to delete this coupon?');">
