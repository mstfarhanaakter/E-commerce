    ...
    <div class="row px-xl-5">
        ...
        <div class="col-lg-3 d-none d-lg-block"> 
            <a class="btn d-flex align-items-center justify-content-between bg-warning w-100" data-bs-toggle="collapse"
                href="#navbar-vertical" style="height: 65px;">
                <h6 class="text-dark m-0 rounded-0"><i class="fa fa-bars me-2"></i>Categories</h6>
        ...
        <div class="col-lg-9">
            <nav class="navbar navbar-expand-lg bg-dark navbar-dark py-3 py-lg-0 px-0">
                <a href="../index1.php?page=1" class="text-decoration-none d-block d-lg-none">
                    <span class="h1 text-uppercase text-dark bg-warning px-2">Dora</span>
                    <span class="h1 text-uppercase text-dark bg-warning px-2 ms-n1">Mart</span>
                </a>
