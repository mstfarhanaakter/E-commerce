<!-- Footer Start -->
        ...
        <div class="row border-top mx-xl-5 py-4" style="border-color: rgba(256, 256, 256, .1) !important;">
            <div class="col-md-6 px-xl-0">
                <p class="mb-md-0 text-center text-md-left text-secondary">
                    &copy; <a class="text-warning" href="#">Domain</a>. All Rights Reserved.
                    <a class="text-warning" href="https://htmlcodex.com">DoraMart</a>
                </p>
            </div>
    ...
    <!-- Back to Top -->
<a href="#" class="btn btn-warning back-to-top position-fixed d-flex align-items-center justify-content-center">
