    ...
    <div class="row px-xl-5">
        ...
        <div class="col-lg-9">
            <nav class="navbar navbar-expand-lg bg-dark navbar-dark py-3 py-lg-0 px-0">
                <a href="../index1.php?page=index" class="text-decoration-none d-block d-lg-none">
                ...
                <div class="collapse navbar-collapse justify-content-between" id="navbarCollapse">
                    ...
                    <div class="navbar-nav me-auto py-0">
                        <a href="../index1.php?page=home" class="nav-item nav-link active">Home</a>
                        ...
                        <a href="contact.php?page=contace" class="nav-item nav-link">Contact</a>
                    </div>
